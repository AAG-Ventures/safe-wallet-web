...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Saakuru Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using {'Saakuru Safe'}</h4>
    <p>
      When visiting our website or using {'Saakuru Safe'}, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the {'Saakuru Safe'}, we process your
        <ol>
    ...
    <p>
      In addition, we may take a recording of you while testing {'Saakuru Safe'} for internal and external use. The
    ...
    <p>
      {'Saakuru Safe'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'Saakuru Safe'} mobile app via biometrics information (touch ID or face ID).
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Saakuru Safe`}. For
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Saakuru Safe – Privacy policy'}</title>
      </Head>
